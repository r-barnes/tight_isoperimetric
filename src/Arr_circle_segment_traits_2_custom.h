...
#ifndef CGAL_ARR_CIRCLE_SEGMENT_TRAITS_2_CUSTOM_H
#define CGAL_ARR_CIRCLE_SEGMENT_TRAITS_2_CUSTOM_H
...
class Arr_circle_segment_traits_2_custom {
public:
  ...
  typedef Arr_circle_segment_traits_2_custom<Kernel, Filter>    Self;
...
public:
  /*! Default constructor. */
  Arr_circle_segment_traits_2_custom (bool use_intersection_caching = false) :
  ...
  private:
    typedef Arr_circle_segment_traits_2_custom<Kernel_, Filter> Self;
  ...
  {
  protected:
    typedef Arr_circle_segment_traits_2_custom<Kernel, Filter> Traits;
    ...
    friend class Arr_circle_segment_traits_2_custom<Kernel, Filter>;
...
public:
  ...
  class Approximate_2 {
  protected:
    using Traits = Arr_circle_segment_traits_2_custom<Kernel, Filter>;
